...
| 指標                | 數值                              |
| ------------------- | --------------------------------- |
| 🟢 A 等級（優秀）   | 27 篇（6.2%）→ 山岳與登山文化 F→A |
| 🟢 B 等級（有腳註） | 5 篇（1.2%）                      |
| 🟡 C 等級（有URL）  | 341 篇（78.6%）                   |
| 🟡 D 等級（少URL）  | 27 篇（6.2%）                     |
| 🔴 F 等級（裸奔）   | 34 篇（7.8%）                     |
| 📊 腳註覆蓋率       | 32/434 = **7.4%**                 |
| 📊 裸奔率           | 34/434 = **7.8%**                 |
...
- **quality-scan 高度可疑 46%**：205/449 篇得分 ≥ 8，最差文章：台灣金融科技發展[14]、澎湖民俗文化[14]、電子商務與數位支付[14]、台灣婚喪喜慶[14]（山岳與登山文化已從[16]降至[4]）。
