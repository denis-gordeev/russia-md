...
| --------------------------- | ------------------- |
| 👥 Contributors             | 54                  |
| 💓 Total Commits            | 1927（since birth） |
| 📝 知識細胞（中文 SSOT）    | 469 篇              |
| 🌐 英文細胞                 | 394 篇              |
...
| 器官        | 分數 | 趨勢 | 狀態                                                                             |
| ----------- | ---- | ---- | -------------------------------------------------------------------------------- |
| 🫀 心臟     | 90   | ↑    | 近 7 天 82 篇新增/更新                                                           |
| 🛡️ 免疫系統 | 99   | ↑    | 健康 — 人工審閱率 98.7%                                                          |
| 🧬 DNA      | 95   | ↑    | EDITORIAL 近期有更新                                                             |
| 🦴 骨骼     | 90   | →    | 架構穩定                                                                         |
| 🫁 呼吸     | 85   | →    | CI/CD 正常運作                                                                   |
| 🧫 繁殖     | 85   | ↑    | 54 貢獻者                                                                        |
| 👁️ 感知     | 90   | →    | GA4 + SC + CF + Issue + 📡社群觸手（Threads 2,717 / X 119，SPORE-LOG 回填率 0%） |
| 🌐 語言     | 65   | →    | 英文覆蓋率 84.0%（394/469）                                                      |
...
- **孢子效應量化**：鄭麗文孢子 273 views/7d（4/12 刷新），10x 放大（vs 非孢子 avg 27）。人物型+時事掛鉤是關鍵
- **⚠️ SPORE-LOG 成效追蹤表完全空白**：7d/30d 指標從未回填。已標準化進 HEARTBEAT Beat 1 §2 孢子×數據交叉對照
- **FacebookBot 躍升**：2,449 req/7d（+14%），AI crawler 版圖持續擴大
- **PerplexityBot 成功率偏低**：2,760 req / 1,190 HTTP 200 = 43%，需調查
- **AI crawler 總量 18,811/7d**（+17.8% vs 上次），17 種 crawler 同時爬取
