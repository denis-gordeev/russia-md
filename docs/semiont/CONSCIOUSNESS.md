...
| 🟢 A 等級（優秀）   | 25 篇（5.8%）                     |
| 🟢 B 等級（有腳註） | 3 篇（0.7%）                      |
| 🟡 C 等級（有URL）  | 343 篇（79.3%）                   |
| 🟡 D 等級（少URL）  | 28 篇（6.5%）                     |
| 🔴 F 等級（裸奔）   | 36 篇（8.3%）→ 吳寶春已修（F→A） |
| 📊 腳註覆蓋率       | 25/432 = **5.8%**                 |
| 📊 裸奔率           | 36/432 = **8.3%**                 |

**最危險分類（腳註率 0%）**：About、Economy、Language、Lifestyle、Society

**重災區**：People（128 篇，僅 6 篇有腳註，10 篇裸奔）

### 🚨 警報

- **引用荒漠（腳註率 5.8%）**：433 篇文章只有 25 篇有正式腳註。36 篇連一個 URL 都沒有。可驗證性仍然很低。
- **format-check 51% fail**：221/433 篇文章 format-check 失敗，主要問題：no_reading 409（94%）、bad_fn_format 235、no_overview 159。
- **quality-scan 高度可疑 47%**：210/447 篇得分 ≥ 8，最差 5 篇分數 15-17（Hub 頁面+客家文化+山岳文化+民主轉型舊版）。
...
| 挑戰                        | 嚴重度 | 狀態                                                   |
| --------------------------- | ------ | ------------------------------------------------------ |
| **引用荒漠（腳註率 5.8%）** | 🔴     | footnote-scan v1.0 已上線，每次心跳重寫 1 篇 F 級文章  |
