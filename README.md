...
- [ ] Add CRLF front-matter fixtures so source line diagnostics stay correct across Windows-authored markdown
- [ ] Add coverage for percent-encoded and non-ASCII markdown fragments, including malformed URI escape diagnostics
