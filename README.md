...
- [ ] Add path-scoped fixture coverage for `--markdown-hidden-file-limit` so scoped runs keep predictable hidden-file summaries
- [ ] Surface the active hidden-file summary override in truncation diagnostics so local debugging can see which cap applied
