...
- [ ] Ignore anchor-like HTML inside markdown comments and inline code while preserving real explicit IDs
...
- [ ] Add multiline HTML-tag coverage so explicit IDs remain detectable when attributes wrap across source lines
