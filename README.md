...
- [ ] Add Setext-heading anchor extraction and collision coverage alongside ATX headings
- [ ] Validate unquoted HTML `id` attributes with the same duplicate, empty, and collision diagnostics
- [ ] Decode HTML entities in explicit IDs before local-fragment resolution and collision checks
- [ ] Add CRLF regression coverage for multiline HTML tags, comments, and inline-code masking
