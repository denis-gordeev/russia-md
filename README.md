...
- Kept Setext-like content inside fenced code and HTML comments out of the anchor index.
- Added fixture coverage for valid links to both Setext levels, repeated Setext headings, and explicit-ID collisions before and after a Setext heading.
